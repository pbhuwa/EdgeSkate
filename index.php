    ...
    <div class="container set-pad">
           ...
           <div class="row" >
                 ...
                 <div class="col-lg-6  col-md-6 col-sm-6" data-scroll-reveal="enter from the bottom after 0.4s">
                     ...
                     <img src="assets/img/person-1.jpg"  class="img-rounded" style="width:230px;height:200px;"/>
                   <h3>BHUWAN PARIYAR</h3>
                 <hr />
                         <h4>BE Computer Engineer</h4>
                   <p >
                        Bhuwan Pariyar, is the developer of this site. 
                        he studied at Acme Engineering College and taking up Bachelor of Computer Engineering. 
                 ...
                 <div class="col-lg-6  col-md-6 col-sm-6" data-scroll-reveal="enter from the bottom after 0.5s">
                     <div class="faculty-div">
                       <img src="assets/img/person-2.jpg"  class="img-rounded" style="width:230px;height:200px;"/>
                   <h3 >MUKESH KUMAR MAHATO</h3>
                 <hr />
                       <h4>BE Computer Engineer</h4>
                   <p >
                        Mukesh kumar Mahato, is the developer of this site. 
                        he studied at Acme Engineering College and taking up Bachelor of Computer Engineering. 
                        He specialized in Web Development.
...
<br />
    ...
    <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 " data-scroll-reveal="enter from the bottom after 0.4s">
        ...
        <hr />
                    <div >
                        <h4><strong>Call:</strong>  +977 9800000000 </h4>
...
<!-- Script -->
     <!-- CONTACT SECTION END-->
    <div id="footer">
          &copy 2019 EDGE Skateshop| All Rights Reserved |  <a style="color: #fff" target="_blank">Design by : EDGE Team</a>
    </div>
     <!-- FOOTER SECTION END-->
